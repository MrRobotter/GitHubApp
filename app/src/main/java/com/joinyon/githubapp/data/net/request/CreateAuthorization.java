package com.joinyon.githubapp.data.net.request;
...
public class CreateAuthorization {
     ...
     * Tokens not associated with a specific OAuth application
     * (i.e. personal access tokens) must have a unique note.
     */
    public String note;
    /**
