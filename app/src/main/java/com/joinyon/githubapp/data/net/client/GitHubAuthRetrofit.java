...
import com.joinyon.githubapp.data.net.client.core.ApiEndpoint;
import com.joinyon.githubapp.data.net.client.core.BaseOkHttpClient;
import com.joinyon.githubapp.data.net.client.core.BaseRetrofit;
